        ...
        {Array.isArray(contactsArray) ? (
          contactsArray.map((contact: {
            ...
            const contactItems = [
              ...
              {
                label: "Estado",
                children: contact.emergency_contact.status,
              },
              {
                label: "CreatedDate",
                children: contact.emergency_contact.createdDate,
              },
              {
                label: "UpdatedDate",
                children: contact.emergency_contact.updatedDate,
              },
              {
                label: "DeletedDate",
                children: contact.emergency_contact.deletedDate,
              },
            ];
          ...
          <>
            {/* se despliega para add un contacto x */}
              ...
              />
                <Input
                placeholder="Status"
                value={(newEmergencyContact && newEmergencyContact .status) || ''}
